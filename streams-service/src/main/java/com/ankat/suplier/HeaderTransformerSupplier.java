    ...
    private class MessageTransformer implements Transformer<String, String, KeyValue<String, String>> {
        ...
        public KeyValue<String, String> transform(String key, String value) {
            ...
            if (internalHeader.isPresent()) {
                ...
                System.out.printf("%s  INFO [streams-service,%s,] --- %s : Message with key: %s and value: %s", LocalDateTime.now().format(dateTimeFormatter), new String(internalHeader.get().value()), this.getClass().getName(), key, value);
            }
